...
//first, declares three variables using the request: title, text, and createdNote
app.post("/api/notes", (req, res) => {
    ...
    //second, adds the created note to the parsed contents of db.json
    fs.readFile("db/db.json", "utf8", (error, data) => {
        var notes = JSON.parse(data)
        notes.push(createdNote)
        //third, stringifies the notes and rewrites db.json
